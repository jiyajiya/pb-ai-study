...
├── data/
│   └── kr_claims.json         ← 136KB. **플러그인에 동봉되어 배포된다**
...
`data/kr_claims.json`은 스냅샷이다. 고시는 개정되고, 2026.6.11 개정에서만
8종의 일일섭취량이 바뀌었다.
...
"어느 시점 기준인지"를 말할 수 없다. **2026.6.11 개정에서 8종의
일일섭취량이 바뀌었다** — 기준 시점이 안 남으면 옛 수치를 현행으로 읽는다.
...
'마그네슘' → 고시 등재 1건 / 인정 문구 행 1개 / 용량 비교 1건
  상한 초과 1건
  [above] 논문 500 mg vs 고시 94.5 ~ 250 mg
```
